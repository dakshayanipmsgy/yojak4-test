...
safe_page(function () {
    ...
    render_layout($title, function () use ($groups) {
        ?>
        <div class="card" style="display:grid;gap:12px;">
            <div>
                <h2 style="margin:0;"><?= sanitize('Create Template'); ?></h2>
                <p class="muted" style="margin:4px 0 0;"><?= sanitize('Build a reusable template with placeholders from your profile.'); ?></p>
            </div>
                ...
                <div style="display:grid;gap:12px;grid-template-columns: minmax(0,1fr) minmax(240px, 320px);">
                    <div style="display:grid;gap:12px;">
                        ...
                        <label>
                            ...
                            <textarea id="templateBody" name="body" rows="14" required></textarea>
                        </label>

...
safe_page(function () {
    ...
    render_layout($title, function () use ($pack, $progress, $stats, $signedToken, $contractor, $suggestions, $attachments, $missingIds, $annexureTemplates, $annexureTemplatesList, $packFieldsInfo, $catalog, $tableTemplates) {
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(320px,1fr)); gap:12px; margin-top:12px;">
            ...
            <div class="card accordion-card" style="display:grid; gap:12px;" id="checklist-toggle" data-accordion>
                <div class="accordion-header">
                    <div style="display:flex; justify-content:space-between; align-items:center; gap:8px; flex-wrap:wrap; flex:1;">
                        <h3 style="margin:0;"><?= sanitize('Checklist (quick toggle)'); ?></h3>
                        <span class="pill"><?= sanitize(count($pack['checklist'] ?? []) . ' items'); ?></span>
                    </div>
                    <button type="button" class="accordion-toggle" data-accordion-toggle aria-expanded="true"><?= sanitize('Collapse'); ?></button>
                </div>
                <div class="accordion-content" style="display:grid; gap:12px;">
            ...
            <div class="card accordion-card" style="display:grid; gap:12px;" data-accordion>
                <div class="accordion-header">
                    <div>
            ...
            <div class="card accordion-card" style="display:grid; gap:12px;" id="print-center" data-accordion>
                <div class="accordion-header">
                    <div>

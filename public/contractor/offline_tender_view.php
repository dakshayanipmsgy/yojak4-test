        ...
        <div class="card" style="margin-top:12px;display:grid;gap:10px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                ...
                <?php if ($packId): ?>
                    ...
                    <a class="btn secondary" href="/contractor/pack_print.php?packId=<?= sanitize($packId); ?>&doc=full&mode=print&autoprint=1&letterhead=1" target="_blank" rel="noopener"><?= sanitize('Browser Print (May include URL/time)'); ?></a>
                    <span class="muted" style="font-size:12px;"><?= sanitize("If you use browser print, turn off 'Headers and footers' in print dialog."); ?></span>
                <?php endif; ?>

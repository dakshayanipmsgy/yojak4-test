        ...
        <div class="card" style="margin-bottom:16px;">
            <div class="guide-meta">
                <div>
                    ...
                    <p class="muted" style="margin:6px 0 0;">Operational references for staff workflows. Hello, <?= sanitize($user['displayName'] ?? $user['username']); ?>.</p>
                </div>
        ...
        <div class="guide-layout">
            <aside class="guide-sidebar guide-desktop-only">
                <div class="guide-list" id="guide-list">
                    <?php foreach ($sections as $section): ?>
                        <a href="/employees/staff_guide.php?id=<?= sanitize($section['id'] ?? ''); ?>"
            ...
            (() => {
                ...
                if (select) {
                    select.addEventListener('change', () => {
                        ...
                        if (id) {
                            window.location.href = `/employees/staff_guide.php?id=${encodeURIComponent(id)}`;
                        }
                    });
                }

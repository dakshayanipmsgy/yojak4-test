...
safe_page(function () {
    ...
    $title = get_app_config()['appName'] . ' | New Guide Section';
    ...
    render_layout($title, function () {
        ...
        <div class="card">
            <h2 style="margin:0;">New Guide Section</h2>
            <p class="muted" style="margin:6px 0 0;">Create a section using intro, steps, tips, and FAQ blocks. Add content in plain text.</p>
        </div>

        <form method="post" action="/superadmin/guide/create.php" class="editor" id="guide-form">

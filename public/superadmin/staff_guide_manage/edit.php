...
safe_page(function () {
    ...
    $id = staff_guide_sanitize_id((string)($_GET['id'] ?? ''));
    if (!$id) {
    ...
    $title = get_app_config()['appName'] . ' | Edit Staff Guide Section';
    ...
    render_layout($title, function () use ($section, $renderBlock) {
        ...
        <div class="card">
            <h2 style="margin:0;">Edit Staff Guide Section</h2>
            <p class="muted" style="margin:6px 0 0;">Update content blocks and publish status.</p>
        </div>

        <form method="post" action="/superadmin/staff_guide_manage/update.php" class="editor" id="guide-form">
            ...
            <div class="card">
                ...
                <div class="field">
                    ...
                    <select name="audience">
                        <option value="staff" <?= ($section['audience'] ?? '') === 'staff' ? 'selected' : ''; ?>>Staff</option>
                    </select>
                </div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap;">
                <a class="btn secondary" href="/superadmin/staff_guide_manage/index.php">Back</a>

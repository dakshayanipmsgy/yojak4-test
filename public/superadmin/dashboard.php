    ...
    render_layout($title, function () use ($user, $counts, $timezone, $now) {
        ...
        $cards = [
            ...
            [
                ...
                'value' => 'Manage',
                'description' => 'Global default templates for all contractors.',
                'secondary' => 'Create, edit, and deliver requests.',
                'link' => '/superadmin/templates.php',
                'badge' => 'badge-ok',
                'cta' => 'Open Library',
            ],
            [
                'title' => 'Pack Blueprints',
                'value' => 'Manage',
                'description' => 'Global pack blueprints for tender packs.',
                'secondary' => 'Create, edit, and deliver requests.',

    ...
    render_layout($title, function () use ($user, $counts, $timezone, $now) {
        ...
        $cards = [
            ...
            [
                ...
                'value' => $counts['templatesGlobalCount'],
                'description' => 'Templates available for all contractors.',
                'secondary' => 'Contractor templates: ' . $counts['templatesContractorCount'],
                'link' => '/superadmin/templates.php',
                'badge' => $badgeClass((int)$counts['templatesGlobalCount'], 1, 5),
            ],
            [
                'title' => 'Global Pack Templates',
                'value' => $counts['packsGlobalCount'],
                'description' => 'Reusable pack blueprints for tenders.',
                'secondary' => 'Contractor packs: ' . $counts['packsContractorCount'],
                'link' => '/superadmin/packs.php',
                'badge' => $badgeClass((int)$counts['packsGlobalCount'], 1, 5),
            ],
            [
                'title' => 'Template Requests',
                'value' => $counts['templateRequestsOpen'],
                'description' => 'New or in-progress contractor requests.',
                'secondary' => 'Coordinate with staff to deliver.',
                'link' => '/superadmin/template_requests.php',
                'badge' => $badgeClass((int)$counts['templateRequestsOpen'], 1, 4),
            ],
            [
                'title' => 'Support Inbox',

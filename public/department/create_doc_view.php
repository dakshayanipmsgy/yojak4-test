        ...
        <div class="card">
            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
                    <a class="btn" href="/department/create_doc_print.php?docId=<?= urlencode($doc['docId'] ?? ''); ?>&mode=print" target="_blank" rel="noopener">Print</a>
                    <a class="btn secondary" href="/department/create_docs.php">Back to Create Docs</a>
                </div>
            </div>
        </div>

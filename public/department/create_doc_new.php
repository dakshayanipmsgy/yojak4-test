    ...
    render_layout($title, function () use ($template, $templateId, $scope, $grouped, $missing, $tableKeys) {
        ...
        <div class="card">
            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                <a class="btn secondary" href="/department/create_docs.php">Back</a>
            </div>
        </div>

        <form method="post" action="/department/create_doc_generate.php" style="margin-top:12px;display:grid;gap:12px;">
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                ...
                <a class="btn secondary" href="/department/create_docs.php">Cancel</a>
            </div>
        </form>
